...
plt.figure()                        # plot approximation error
plt.plot(xgrid, yapp - yact)
plt.plot(xgrid, np.zeros(ngrid), 'k--', linewidth=2)
plt.xlabel('x')
plt.ylabel('Error')
plt.title('Chebychev Approximation Error for exp(-x)')
plt.show()
...
plt.xlabel('x')
plt.ylabel('Error')
plt.title('Cubic Spline Approximation Error for exp(-x)')
plt.show()
...
plt.xlabel('x')
plt.ylabel('Error')
plt.title('Linear Spline Approximation Error for exp(-x)')
plt.show()
